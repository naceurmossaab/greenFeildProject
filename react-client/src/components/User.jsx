...
const UserPofile = ({ user }) => (
     <div className='profile'>
          ...
          <div className='userDetails'>
               ...
               <div> <Image cloudName='geekitten' public_id='kbtpnsfb2vkmzbskbp1n' /></div>
          </div>
     </div>
);
...
const AddPostOwner = (props) => {
     ...
     return (
          <div className='inputContainer contact'>
               <input className="adresse-input" type='text' onChange={(e) => setadresse(e.target.value)} placeholder="adresse" />
               <input className="room-input" type='text' onChange={(e) => setnumberOfRooms(e.target.value)} placeholder="number of rooms" />
               <input className="price-input" type='text' onChange={(e) => setprice(e.target.value)} placeholder="price"/>
               <textarea cols='35' rows='7' onChange={(e) => setdescription(e.target.value)} placeholder="message ..." >
               </textarea>
               <input type='file' onChange={(e) => setpics([...pics, e.target.files[0]])} />
...
const AddPostRenter = (props) => {
     ...
     return (
          <div className='inputContainer contact'>
               <input className="email-input" type='text' onChange={(e) => settitle(e.target.value)} placeholder="title" />
               <textarea cols='34' rows='10' onChange={(e) => setbody(e.target.value)} placeholder="message ..." >
               </textarea>
               <button onClick={handelSubmit}>Submit</button>
          </div>
     );
